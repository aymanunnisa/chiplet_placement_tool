                    ...
                    if (chiplet_size % 2 == 0): #HACK:even sized chiplet for all configurations
                        ...
                        if simulate_flag == 0:
                            if manhattan_distances:
                                print("\n--- Minimum Manhattan Distance Configuration ---")
                                print(cur_factor_pair)
                                print("Min Manhattan Distance:", min(manhattan_distances))
                                print("Configuration:")
                                for row in min_conf[0]:
                                    print(" ".join(row))
                            '''else:
                                print("no not present", cur_factor_pair)'''
