...
def chip_placement(num_router, num_cores, mc_per_hbm, num_hbm_per_side, num_i,num_chiplet):
...
def main():
    #trace_file = bool(sys.argv[1])
    # Place the chiplets and generate the trace files
    dir_name = chip_placement(num_router = 4, num_cores = 16, mc_per_hbm = 4, num_hbm_per_side = 1, num_i=2, num_chiplet = 4)


    # Simulate the trace files
    # run_booksim(dir_name)
